<div>
    ...
    <div class="content-wrapper">
        ...
        <div class="card">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="card-body">
                        ...
                        <button wire:click="edit({{ Auth::user()->id }})" class="btn btn btn-warning mt-3" data-toggle="modal" data-target="#editModal">
                    ...
                    <div class="card-body">
                        ...
                        <form wire:submit.prevent="updatePassword">
                            <div class="form-group">
                                ...
                                <input type="password" id="password" wire:model="password" class="form-control" placeholder="Password Baru">
                                @error('password') <small class="text-danger">{{ $message }}</small> @enderror
                            </div>
                            <div class="form-group">
                                <label for="password_confirmation">Konfirmasi Password</label>
                                <input type="password" id="password_confirmation" wire:model="password_confirmation" class="form-control" placeholder="Konfirmasi Password">
            ...
            <!-- Hapus Akun -->
            <div class="card-body">
                <h5 class="mb-3 text-danger"><i class="fas fa-trash-alt mr-1"></i> Hapus Akun</h5>
